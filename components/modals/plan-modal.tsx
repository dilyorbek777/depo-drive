    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl">
        <DialogHeader className="flex">
          <Image src={"/logo.png"} className="dark:hidden " alt="one" width={50} height={50} />
          <Image src={"/logo-dark.png"} className="hidden dark:block" alt="one" width={50} height={50} />
          <p>Depo</p>
        </DialogHeader>
...
const planArray = [
  ...
  },
  {
    ...
    priceId: "price_1OdQPWL3xDd4xgqr0PlBrCAb",
  },
];
